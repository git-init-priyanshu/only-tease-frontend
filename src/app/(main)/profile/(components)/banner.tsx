    ...
    <div className='w-full  '>
      <div className=' flex flex-col justify-end items-end'>
        <div className='relative w-full'>
          ...
          <Image
            className='absolute rounded-lg border-white border w-[200px] h-24 sm:w-36 sm:h-36 top-[70%]    '
            src={icon}
            alt='banner image'
          />
        </div>
        ...
        <div className='flex w-[75%]  xl:w-[80%] justify-between items-center  '>
          <div className='flex font-bold text-[10px] xl:text-lg flex-col items-start justify-center '>
            <span className=' flex items-center text-[#1D1B20] ml-5 mt-3'>{name}
            ...
            <span className='ml-5 text-[#79747E]'>@{name.split(" ")[0]}.Tease</span>
          </div>
