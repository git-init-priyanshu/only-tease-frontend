export const NFT_MARKETPLACE_ABI = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_routerCrossChain', type: 'address' },
  ...
  },
  {
    ...
    name: 'luckySubcriberSuccess',
    type: 'event',
  },
  {
    inputs: [],
    name: 'addressOfVRFContract',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'address', name: 'associatedAddress', type: 'address' },
      { internalType: 'uint256', name: 'royaltyFees', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint8', name: 'ntfnAttempts', type: 'uint8' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256[]', name: 'modelIds', type: 'uint256[]' },
  ...
  {
    inputs: [
      { internalType: 'address', name: 'newVrfContract', type: 'address' },
    ],
    name: 'updateVrfContractAddress',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
